...
namespace MvcToIdentityOracle
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(DbFirstContextService.CreateDbContext);
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions
            {
                ...
                Provider = new CookieAuthenticationProvider
                {
                    OnValidateIdentity = SecurityStampValidator.OnValidateIdentity<ApplicationUserManager, IdentityUser>(
                        ...
                        regenerateIdentity: (manager, user) => DbFirstContextService.GenerateUserIdentityAsync(manager, user))
